...
import { ContractIdentifierSchema, JsonObjectSchema, LocaleIdentifierSchema, LocalizedTextSchema } from './common';
...
export const DesignTokenSourceSchema = z.discriminatedUnion('type', [DesignTokenFileSourceSchema, DesignTokenUrlSourceSchema, DesignTokenInlineSourceSchema]);
...
export const TenantDataBindingSchema = z.discriminatedUnion('kind', [
  z
    .object({
...
export const TenantAuthBindingsSchema = z.record(ContractIdentifierSchema, TenantAuthBindingSchema);

export const TenantDataBindingsSchema = z.record(ContractIdentifierSchema, TenantDataBindingSchema);
...
export const CurrentUserMenuDisplayTextSchema = z.union([
  z.string().trim().min(1),
  z.record(z.string().trim().min(1), z.string().trim().min(1)).refine((value) => Object.keys(value).length > 0, 'Localized menu text must contain at least one locale.'),
]);
...
export const CurrentUserMenuItemSchema = z.discriminatedUnion('kind', [CurrentUserMenuNavigationItemSchema, CurrentUserMenuControlItemSchema, CurrentUserMenuActionItemSchema]);
...
const LegacyCurrentUserMenuProfileSchema = z.array(z.enum(LEGACY_CURRENT_USER_MENU_ITEM_IDS)).superRefine((value, context) => {
...
export const CurrentUserMenuProfileSchema = z.union([z.literal('*'), LegacyCurrentUserMenuProfileSchema, CurrentUserMenuConfigSchema]);
...
const WorkbenchCustomerToolSchema = z
  .object({
    id: ContractIdentifierSchema,
...
const WorkbenchStudioOverrideSchema = z
  .object({
...
export const TenantWorkbenchConfigSchema = z
  .object({
              ...
              .object({
                ...
                stroke: z
                  .object({
                    ...
                    widthRatio: z.number().nonnegative().optional(),
                    blurRatio: z.number().nonnegative().optional(),
  ...
  .strict()
  .superRefine(({ pages, pageGroups }, context) => {
    ...
    if (pageIdSet.size !== pageIds.length) {
      context.addIssue({
        code: 'custom',
        path: ['pages'],
        message: 'Tenant workbench page ids must be unique.',
      });
    }
    ...
    if (new Set(groupIds).size !== groupIds.length) {
      context.addIssue({
        code: 'custom',
        path: ['pageGroups'],
        message: 'Tenant workbench page group ids must be unique.',
      });
    }
  ...
  .object({
    theme: z
      .object({
        ...
        form: z
          .object({ variant: z.enum(['bento', 'ghost']) })
          .strict()
          .optional(),
        toast: z
          .object({
        ...
        icons: z
          .object({
            error: CustomIconSchema.optional(),
            empty: CustomIconSchema.optional(),
          })
          .strict()
          .optional(),
        views: z
        ...
        modules: z
          .object({
            ...
            monkeysSpaceHeadbar: z.union([z.literal('*'), z.array(TenantHeadbarModuleItemSchema)]).optional(),
        ...
        statusStates: z
          .object({
            loading: z
              .object({ variant: z.enum(['spinner', 'skeleton']).optional() })
              .strict()
              .optional(),
            empty: z
              .object({ variant: z.enum(['default', 'compact']).optional() })
              .strict()
              .optional(),
      ...
      .object({
        ...
        homeAdvertisement: z
          .object({
            ...
            viewType: z.enum(['filter', 'container', 'share_link']).optional(),
            teamId: ContractIdentifierSchema.optional(),
            teamOnly: z.boolean().optional(),
            pageSize: z.number().int().positive().optional(),
            sortBy: z.enum(['pin_order', 'asset_id', 'updated_timestamp', 'created_timestamp']).optional(),
        ...
        homeShortcutBackground: z
          .object({
            ...
            teamOnly: z.boolean().optional(),
            pageSize: z.number().int().positive().optional(),
            sortBy: z.enum(['pin_order', 'asset_id', 'updated_timestamp']).optional(),
            sortOrder: z.enum(['asc', 'desc']).optional(),
            fieldMap: z.record(z.string(), z.string()).optional(),
            columnIds: z.record(z.string(), z.string()).optional(),
          })
          ...
          .object({
            ...
            runtime: z
              .object({
                ...
                tepBaseUrlConfigured: z.boolean(),
                tepAuthorizationConfigured: z.boolean(),
                tepCookieConfigured: z.boolean(),
              })
              .strict()
              .optional(),
          })
          ...
          .object({
            silentViewLinks: z
              .object({
                ...
                placement: z
                  .object({
                    mode: z.enum(['sourceOntology', 'ontology']).optional(),
                    ontologyId: ContractIdentifierSchema.optional(),
                    parentId: ContractIdentifierSchema.optional(),
                    navId: ContractIdentifierSchema.optional(),
                  })
                  .strict()
                  .optional(),
              })
            ...
            shareAccess: z
              .object({
                ...
                passwordGateEnabled: z.boolean().optional(),
                passwordAccessTtlSeconds: z.number().int().positive().optional(),
                defaultViewTreeDelivery: z.enum(['manual', 'auto']).optional(),
              })
              .strict()
              .optional(),
            shareDialog: z
              .object({
                audience: z
                  .object({
                    enabled: z.boolean().optional(),
                    allowed: z.array(z.enum(['user', 'team', 'public'])).optional(),
                    default: z.enum(['user', 'team', 'public']).optional(),
                  })
                  .strict()
                  .optional(),
                accessLevel: z
                  .object({
                    enabled: z.boolean().optional(),
                    allowed: z.array(z.enum(['read', 'write'])).optional(),
                    default: z.enum(['read', 'write']).optional(),
                  })
                  .strict()
                  .optional(),
                viewTreeDelivery: z
                  .object({
                    enabled: z.boolean().optional(),
                    allowed: z.array(z.enum(['manual', 'auto'])).optional(),
                    default: z.enum(['manual', 'auto']).optional(),
                  })
                  .strict()
                  .optional(),
              })
        ...
        integrations: z
          .object({
            ...
            gitlab: z
              .object({
                baseUrl: z.string().optional(),
                groupScopes: z.array(z.string()).optional(),
                tokenMode: z.string().optional(),
                deployProjectPath: z.string().optional(),
                deploymentReportsEnabled: z.boolean().optional(),
                proxyUrl: z.string().optional(),
              })
              .strict()
              .optional(),
            kubernetes: z
              .object({
                ...
                clusterAlias: z.string().optional(),
                agentProjectPath: z.string().optional(),
                agentName: z.string().optional(),
                namespaceScopes: z.array(z.string()).optional(),
                rolloutObserverEnabled: z.boolean().optional(),
                proxyUrl: z.string().optional(),
              })
              .strict()
              .optional(),
    ...
    storage: z
      ...
      .strict()
      .optional(),
    monkeyData: z.object({ baseUrl: z.string().optional() }).strict().optional(),
  })
  .strict();
